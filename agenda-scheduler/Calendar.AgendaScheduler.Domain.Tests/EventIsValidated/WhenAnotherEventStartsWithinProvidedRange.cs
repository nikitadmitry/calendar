...
{
    public class WhenAnotherEventStartsWithinProvidedRange : EventValidatorFixture
    {
        public WhenAnotherEventStartsWithinProvidedRange()
        {
            EventExists(new Event
            {
                Start = new DateTime(2022, 4, 1, 15, 30, 0),
                End = new DateTime(2022, 4, 1, 17, 00, 0)
            });
        }
